...
public class Application {
	public static void main(String[] args) {
		IAccountService zaccountService = new AccountService();
		ClassLoader cl = IAccountService.class.getClassLoader();
		IAccountService accountService = (IAccountService) Proxy.newProxyInstance(cl, new Class[] { IAccountService.class }, new Timer(zaccountService));
		// create 2 accounts;
