...
import bank.command.impl.DepositCommand;
import bank.command.impl.TransferCommand;
import bank.command.impl.WithdrawCommand;
...
public class Application {
	public static void main(String[] args) {
		...
		TransferCommand transferFundsCommand1 = new TransferCommand(accountService,4253892, 1263862, 100, "payment of invoice 10232");
