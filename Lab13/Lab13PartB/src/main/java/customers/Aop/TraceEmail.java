...
public class TraceEmail {
    ...
    public void trace(JoinPoint joinpoint, String email, String message) {
        ...
        System.out.println(LocalDateTime.now() + " method= " +
                joinpoint.getSignature().getName()+ " address= "
                + email + " message= " + message + " outgoingMailServer= " + emailSender.getOutgoingMailServer());
    }
}
